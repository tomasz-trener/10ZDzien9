...
namespace P02AplikacjaBazodanowa.Models
{
    ...
    partial void OnnoweChanging(string value);
    partial void OnnoweChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_nowe", DbType="NChar(10)")]
		public string nowe
		{
			get
			{
			...
			set
			{
				if ((this._nowe != value))
				{
					this.OnnoweChanging(value);
					this.SendPropertyChanging();
					this._nowe = value;
					this.SendPropertyChanged("nowe");
					this.OnnoweChanged();
				}
			}
		}
